...
2. **No arguments (default)**: Review all uncommitted changes
   ...
   - `jj`:
     - Run: `jj diff` for changes in current working copy
   - `hg`:
...
5. **Branch or Bookmark name**: Compare current branch/working copy to the specified branch/bookmark
   ...
   - `jj`
     - Run: `jj diff --from $ARGUMENTS`

6. **PR URL or number** (contains "github.com" or "pull" or looks like a PR number): Review the pull request
