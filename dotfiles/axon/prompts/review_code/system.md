...
A numbered list of the most important changes, ordered from most to least critical. Only include recommendations that is not yet implemented in the code.
